...
public class GeneratorMatrixPixel {
	...
	private final Color[] color = {new Color(143,18,43),new Color(222,184,135),new Color(222,184,135),new Color(222,184,135),
									new  Color(222,184,135),new Color(240,248,235),new Color(220,20,60),new Color(139,0,139),
