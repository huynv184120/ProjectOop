...
// Lay 4 dinh cua vung nhin thay
	...
	class Image{
		...
		public Image(){
		this.widthImg = (int)(Math.tan(angleWidth/2)*Math.sqrt(500000/(Math.tan(angleWidth/2)*Math.cos(angleHeight/2))));
		this.heightImg = (int)(Math.tan(angleHeight/2)*Math.sqrt(500000/(Math.tan(angleWidth/2)*Math.cos(angleHeight/2))));
